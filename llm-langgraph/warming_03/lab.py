...
def tokens_from_string(string:str) -> int:
    ...
    return f"This string has {len(encoding.encode(string))} tokens."
...
print("\n")
question = "Quem é caboco Capiroba? Quantos tokens minha pergunta tem?"
